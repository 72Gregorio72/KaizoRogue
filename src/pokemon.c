...
{
    return GetSpeciesBaseStat(species, STAT_ATK);
}

u32 GetSpeciesBaseDefense(enum Species species)
{
    return GetSpeciesBaseStat(species, STAT_DEF);
}

u32 GetSpeciesBaseSpeed(enum Species species)
{
    return GetSpeciesBaseStat(species, STAT_SPEED);
}

u32 GetSpeciesBaseSpAttack(enum Species species)
{
    return GetSpeciesBaseStat(species, STAT_SPATK);
}

u32 GetSpeciesBaseSpDefense(enum Species species)
{
    return GetSpeciesBaseStat(species, STAT_SPDEF);
}
...
u32 GetSpeciesBaseStat(enum Species species, u32 statIndex)
{
    ...
    GetRandomizedBaseStats(species, randomizedStats);
